...
ALTER TABLE `jacq_input`.`tbl_living_plant`
CHANGE COLUMN `reviewed` `reviewed` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '';
...
ALTER TABLE `jacq_input`.`tbl_image_server`
ADD COLUMN `last_synchronized` DATETIME NULL DEFAULT NULL COMMENT '' AFTER `key`;
...
ALTER TABLE `jacq_input`.`tbl_living_plant`
ADD COLUMN `has_image` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '' AFTER `reviewed`,
ADD COLUMN `has_public_image` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '' AFTER `has_image`;
