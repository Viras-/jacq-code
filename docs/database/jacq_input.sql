...
CREATE TABLE IF NOT EXISTS `tbl_separation` (
  ...
  `separation_type_id` INT NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `tbl_specimen` (
  ...
  `curatorial_unit_id` INT(11) NOT NULL COMMENT '',
  `barcode` VARCHAR(20) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `tbl_curatorial_unit_type` (
  `curatorial_unit_type_id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
...
CREATE TABLE IF NOT EXISTS `tbl_curatorial_unit` (
  `curatorial_unit_id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `curatorial_unit_type_id` INT(11) NOT NULL COMMENT '',
  `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '',
