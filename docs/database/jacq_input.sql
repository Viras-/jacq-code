...
-- -----------------------------------------------------
-- Table `tbl_curatorial_unit_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tbl_curatorial_unit_type` ;

CREATE TABLE IF NOT EXISTS `tbl_curatorial_unit_type` (
  `curatorial_unit_type_id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `type_name` VARCHAR(45) NOT NULL COMMENT '',
  `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`curatorial_unit_type_id`)  COMMENT '')
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `tbl_curatorial_unit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tbl_curatorial_unit` ;

CREATE TABLE IF NOT EXISTS `tbl_curatorial_unit` (
  `curatorial_unit_id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `curatorial_unit_type_id` INT NOT NULL COMMENT '',
  `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`curatorial_unit_id`)  COMMENT '',
  INDEX `fk_tbl_curatorial_unit_tbl_curatorial_unit_type1_idx` (`curatorial_unit_type_id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `tbl_specimen` (
  `specimen_id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `botanical_object_id` INT NOT NULL COMMENT '',
  `curatorial_unit_id` INT NOT NULL COMMENT '',
  `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`specimen_id`)  COMMENT '',
  INDEX `fk_tbl_specimen_tbl_botanical_object1_idx` (`botanical_object_id` ASC)  COMMENT '',
  INDEX `fk_tbl_specimen_tbl_curatorial_unit1_idx` (`curatorial_unit_id` ASC)  COMMENT '',
  CONSTRAINT `fk_tbl_specimen_tbl_botanical_object1`
    FOREIGN KEY (`botanical_object_id`)
    REFERENCES `tbl_botanical_object` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_specimen_tbl_curatorial_unit1`
...
-- -----------------------------------------------------
-- Table `frmwrk2_auth_rule`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `frmwrk2_auth_rule` ;

CREATE TABLE IF NOT EXISTS `frmwrk2_auth_rule` (
...
-- -----------------------------------------------------
-- Table `frmwrk2_auth_item`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `frmwrk2_auth_item` ;

CREATE TABLE IF NOT EXISTS `frmwrk2_auth_item` (
  `name` VARCHAR(64) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL COMMENT '',
  `type` INT(11) NOT NULL COMMENT '',
  ...
  CONSTRAINT `frmwrk2_auth_item_ibfk_1`
    FOREIGN KEY (`rule_name`)
    REFERENCES `frmwrk2_auth_rule` (`name`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `frmwrk2_auth_assignment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `frmwrk2_auth_assignment` ;

CREATE TABLE IF NOT EXISTS `frmwrk2_auth_assignment` (
  `item_name` VARCHAR(64) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL COMMENT '',
  `user_id` INT NOT NULL COMMENT '',
  `created_at` INT(11) NULL DEFAULT NULL COMMENT '',
  PRIMARY KEY (`item_name`, `user_id`)  COMMENT '',
  INDEX `fk_frmwrk2_auth_assignment_frmwrk_user1_idx` (`user_id` ASC)  COMMENT '',
  CONSTRAINT `frmwrk2_auth_assignment_ibfk_1`
    FOREIGN KEY (`item_name`)
    REFERENCES `frmwrk2_auth_item` (`name`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_frmwrk2_auth_assignment_frmwrk_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `frmwrk_user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `frmwrk2_auth_item_child`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `frmwrk2_auth_item_child` ;

CREATE TABLE IF NOT EXISTS `frmwrk2_auth_item_child` (
  ...
  PRIMARY KEY (`parent`, `child`)  COMMENT '',
  INDEX `child` (`child` ASC)  COMMENT '',
  CONSTRAINT `frmwrk2_auth_item_child_ibfk_1`
    FOREIGN KEY (`parent`)
    REFERENCES `frmwrk2_auth_item` (`name`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `frmwrk2_auth_item_child_ibfk_2`
    FOREIGN KEY (`child`)
    REFERENCES `frmwrk2_auth_item` (`name`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `tbl_identifier_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tbl_identifier_type` ;

CREATE TABLE IF NOT EXISTS `tbl_identifier_type` (
  `identifier_type_id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `type` VARCHAR(45) NOT NULL COMMENT '',
  `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`identifier_type_id`)  COMMENT '')
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `tbl_identifier`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tbl_identifier` ;

CREATE TABLE IF NOT EXISTS `tbl_identifier` (
  `identifier_id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `identifier_type_id` INT NOT NULL COMMENT '',
  `identifier` VARCHAR(45) NOT NULL COMMENT '',
  `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`identifier_id`)  COMMENT '',
  INDEX `fk_tbl_identifier_tbl_identifier_type1_idx` (`identifier_type_id` ASC)  COMMENT '',
  CONSTRAINT `fk_tbl_identifier_tbl_identifier_type1`
    FOREIGN KEY (`identifier_type_id`)
    REFERENCES `tbl_identifier_type` (`identifier_type_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tbl_curatorial_unit_identifier`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tbl_curatorial_unit_identifier` ;

CREATE TABLE IF NOT EXISTS `tbl_curatorial_unit_identifier` (
  `curatorial_unit_id` INT NOT NULL COMMENT '',
  `identifier_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`curatorial_unit_id`, `identifier_id`)  COMMENT '',
  INDEX `fk_tbl_curatorial_unit_identifier_tbl_identifier1_idx` (`identifier_id` ASC)  COMMENT '',
  CONSTRAINT `fk_tbl_curatorial_unit_identifier_tbl_curatorial_unit1`
    FOREIGN KEY (`curatorial_unit_id`)
    REFERENCES `tbl_curatorial_unit` (`curatorial_unit_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_curatorial_unit_identifier_tbl_identifier1`
    FOREIGN KEY (`identifier_id`)
    REFERENCES `tbl_identifier` (`identifier_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tbl_specimen_identifier`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tbl_specimen_identifier` ;

CREATE TABLE IF NOT EXISTS `tbl_specimen_identifier` (
  `specimen_id` INT NOT NULL COMMENT '',
  `identifier_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`specimen_id`, `identifier_id`)  COMMENT '',
  INDEX `fk_tbl_specimen_identifier_tbl_identifier1_idx` (`identifier_id` ASC)  COMMENT '',
  CONSTRAINT `fk_tbl_specimen_identifier_tbl_specimen`
    FOREIGN KEY (`specimen_id`)
    REFERENCES `tbl_specimen` (`specimen_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_specimen_identifier_tbl_identifier1`
    FOREIGN KEY (`identifier_id`)
    REFERENCES `tbl_identifier` (`identifier_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Data for table `tbl_identifier_type`
-- -----------------------------------------------------
START TRANSACTION;
USE `jacq_input`;
INSERT INTO `tbl_identifier_type` (`identifier_type_id`, `type`, `timestamp`) VALUES (1, 'inventory_number', NOW());
INSERT INTO `tbl_identifier_type` (`identifier_type_id`, `type`, `timestamp`) VALUES (2, 'acquisition_number', NOW());
INSERT INTO `tbl_identifier_type` (`identifier_type_id`, `type`, `timestamp`) VALUES (3, 'barcode', NOW());
