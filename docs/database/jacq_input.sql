...
CREATE TABLE IF NOT EXISTS `tbl_derivative_vegetative` (
  ...
  `accesion_number` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `organisation_id` INT NOT NULL COMMENT '',
  ...
  CONSTRAINT `fk_tbl_vegetative_derivative_tbl_living_plant1`
...
CREATE TABLE IF NOT EXISTS `tbl_separation` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `botanical_object_id` INT NOT NULL COMMENT '',
  `vegetative_derivative_id` INT NOT NULL COMMENT '',
  ...
  INDEX `fk_tbl_separation_tbl_vegetative_derivative1_idx` (`vegetative_derivative_id` ASC)  COMMENT '',
  ...
  CONSTRAINT `fk_tbl_separation_tbl_botanical_object1`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_tbl_separation_tbl_vegetative_derivative1`
    FOREIGN KEY (`vegetative_derivative_id`)
    REFERENCES `tbl_derivative_vegetative` (`living_plant_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
