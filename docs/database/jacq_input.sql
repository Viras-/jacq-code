...
CREATE TABLE IF NOT EXISTS `tbl_curatorial_unit_type` (
  `curatorial_unit_type_id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tbl_curatorial_unit` (
  `curatorial_unit_id` INT NOT NULL AUTO_INCREMENT,
  `curatorial_unit_type_id` INT NOT NULL,
  `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `tbl_specimen` (
  ...
  `botanical_object_id` INT NOT NULL,
  `curatorial_unit_id` INT NOT NULL,
  `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`specimen_id`),
  INDEX `fk_tbl_specimen_tbl_botanical_object1_idx` (`botanical_object_id` ASC),
  INDEX `fk_tbl_specimen_tbl_curatorial_unit1_idx` (`curatorial_unit_id` ASC),
...
CREATE TABLE IF NOT EXISTS `tbl_inventory_object` (
  ...
  `message` INT NOT NULL COMMENT 'Logging message produced by inventory type handler',
  `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `frmwrk2_auth_assignment` (
  ...
  INDEX `fk_frmwrk2_auth_assignment_frmwrk_user1_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `tbl_identifier` (
  ...
  INDEX `fk_tbl_identifier_tbl_identifier_type1_idx` (`identifier_type_id` ASC),
...
CREATE TABLE IF NOT EXISTS `tbl_curatorial_unit_identifier` (
  ...
  PRIMARY KEY (`curatorial_unit_id`, `identifier_id`),
  INDEX `fk_tbl_curatorial_unit_identifier_tbl_identifier1_idx` (`identifier_id` ASC),
...
CREATE TABLE IF NOT EXISTS `tbl_specimen_identifier` (
  ...
  `identifier_id` INT NOT NULL,
  PRIMARY KEY (`specimen_id`, `identifier_id`),
  INDEX `fk_tbl_specimen_identifier_tbl_identifier1_idx` (`identifier_id` ASC),
