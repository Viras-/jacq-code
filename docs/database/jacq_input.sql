...
CREATE TABLE IF NOT EXISTS `tbl_living_plant` (
  ...
  `has_public_image` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `tbl_derivative_vegetative` (
  ...
  UNIQUE INDEX `accesion_number_UNIQUE` (`accession_number` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `tbl_separation` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `botanical_object_id` INT NULL DEFAULT NULL COMMENT '',
  `derivative_vegetative_id` INT NULL DEFAULT NULL COMMENT '',
  ...
  INDEX `fk_tbl_separation_tbl_derivative_vegetative1_idx` (`derivative_vegetative_id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `tbl_specimen` (
  ...
  `botanical_object_id` INT(11) NOT NULL COMMENT '',
  `herbar_number` VARCHAR(20) NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `tbl_image_server` (
  ...
  `last_synchronized` DATETIME NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `tbl_index_seminum_content` (
  ...
  `botanical_object_id` INT NOT NULL COMMENT '',
  `accession_number` TEXT NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `rev_classification` (
  `classification_browser_revision_id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '',
  `uuid_minter_id` INT NOT NULL COMMENT '',
  `classification_id` INT(11) NOT NULL DEFAULT '0' COMMENT '',
  `scientific_name_id` INT(11) NOT NULL DEFAULT '0' COMMENT '',
  `acc_scientific_name_id` INT(11) NULL DEFAULT NULL COMMENT '',
  `ref_date` DATE NULL DEFAULT NULL COMMENT '',
  `preferred_taxonomy` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '',
  `annotations` LONGTEXT NULL DEFAULT NULL COMMENT '',
  `locked` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '',
  `source` VARCHAR(20) NOT NULL DEFAULT '' COMMENT '',
  `source_id` BIGINT(11) NULL DEFAULT NULL COMMENT '',
  `user_id` INT(11) NOT NULL COMMENT '',
  `timestamp` DATETIME NOT NULL COMMENT '',
  `parent_scientific_name_id` INT(11) NULL DEFAULT NULL COMMENT '',
  `number` VARCHAR(15) NULL DEFAULT NULL COMMENT '',
  `order` INT(11) NULL DEFAULT NULL COMMENT '',
  `scientific_name` TEXT NULL DEFAULT NULL COMMENT '',
  `scientific_name_no_author` TEXT NULL DEFAULT NULL COMMENT '',
  PRIMARY KEY (`classification_browser_revision_id`)  COMMENT '',
  INDEX `fk_tbl_classification_browser_revision_srvc_uuid_minter1_idx` (`uuid_minter_id` ASC)  COMMENT '',
  INDEX `uuid_minter_id` (`uuid_minter_id` ASC, `acc_scientific_name_id` ASC)  COMMENT '',
...
BEGIN
    ...
    INSERT INTO `rev_classification`(`uuid_minter_id`, `classification_id`, `scientific_name_id`, `acc_scientific_name_id`, `ref_date`, `preferred_taxonomy`, `annotations`, `locked`, `source`, `source_id`, `user_id`, `timestamp`, `parent_scientific_name_id`, `number`, `order`, `scientific_name`, `scientific_name_no_author`)
    SELECT @uuid_minter_id, `classification_id`, `scientific_name_id`, `acc_scientific_name_id`, `ref_date`, `preferred_taxonomy`, `annotations`, `locked`, `source`, `source_id`, `user_id`, `timestamp`, `parent_scientific_name_id`, `number`, `order`, GetScientificName(`scientific_name_id`, 0, 0), GetScientificName(`scientific_name_id`, 0, 1) FROM `tbl_classification` WHERE `source` =  `i_source` AND `source_id` = `i_source_id`;
END$$
