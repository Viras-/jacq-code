...
CREATE TABLE IF NOT EXISTS `tbl_living_plant` (
  ...
  `bcgi` TINYINT(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `tbl_inventory_object` (
  ...
  `botanical_object_id` INT NOT NULL,
  `log_id` INT NOT NULL COMMENT 'Reference to log table containing the previous record (for displaying the old value)',
