...
/**
 * This is the model class for table "jacq_input.tbl_relevancy_type".
 *
 * The followings are the available columns in table 'jacq_input.tbl_relevancy_type':
 * @property integer $id
...
class RelevancyType extends CActiveRecord
{
	...
	{
		return 'jacq_input.tbl_relevancy_type';
	}
