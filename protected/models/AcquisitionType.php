...
/**
 * This is the model class for table "tbl_acquisition_type".
 *
 * The followings are the available columns in table 'tbl_acquisition_type':
 * @property integer $id
 ...
 */
class AcquisitionType extends ActiveRecord {
