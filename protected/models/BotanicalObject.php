...
/**
 * This is the model class for table "jacq_input.tbl_botanical_object".
 *
 * The followings are the available columns in table 'jacq_input.tbl_botanical_object':
 * @property integer $id
...
class BotanicalObject extends CActiveRecord
{
	...
	{
		return 'jacq_input.tbl_botanical_object';
	}
	...
	public function rules()
	{
		...
		return array(
			array('id, acquisition_event_id, separation_id, phenology_id, taxon_id', 'required'),
			array('id, acquisition_event_id, separation_id, phenology_id, taxon_id, determined_by_id', 'numerical', 'integerOnly'=>true),
