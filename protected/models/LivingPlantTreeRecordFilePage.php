 ...
 */
class LivingPlantTreeRecordFilePage extends ActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            ...
            'tree_record_file_page_id' => Yii::t('jacq', 'Tree Record File Page'),
            'corrections_done' => Yii::t('jacq', 'Corrections Done'),
            'corrections_date' => Yii::t('jacq', 'Corrections Date'),
        );
    }
