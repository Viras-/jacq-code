...
class InventoryObject extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('inventory_id, botanical_object_id, log_id', 'required'),
            array('inventory_id, botanical_object_id, log_id', 'numerical', 'integerOnly' => true),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('inventory_object_id, inventory_id, botanical_object_id, log_id', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            'inventory_object_id' => 'Inventory Object',
