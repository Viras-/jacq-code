...
/**
 * This is the model class for table "jacq_input.tbl_phenology".
 *
 * The followings are the available columns in table 'jacq_input.tbl_phenology':
 * @property integer $id
...
class Phenology extends CActiveRecord
{
	...
	{
		return 'jacq_input.tbl_phenology';
	}
