...
class ScientificNameInformation extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('spatial_distribution, variety, common_names, growth_form', 'length', 'max' => 255),
    ...
    public function attributeLabels() {
        return array(
            ...
            'growth_form' => Yii::t('jacq', 'Growth Form'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('growth_form', $this->growth_form, true);
