<div class="wide form">
    ...
    <div class="row">
        <table border="0" width="100%">
            <tr>
                ...
                <td>
                    <?php echo $form->label($model, 'organisation_hierarchy_search'); ?>
                    <?php echo $form->checkBox($model, 'organisation_hierarchy_search'); ?>
                </td>
            </tr>
    ...
    <div class="row">
        ...
        echo CHtml::checkBoxList(
                'LivingPlant[label_type_search]', CHtml::listData($model, 'label_type_search', 'label_type_search'), Html::listDataSorted(
                        LabelType::model()->findAll(), 'label_type_id', 'typeTranslated'
                ), array(
            'separator' => '<br/>'
                )
        );
