...
if ($model_specimen->id_specimen > 0) {
    $model_form_id = $model_specimen->id_specimen;
}
else {
...
<div id="specimen_row_<?php echo $model_form_id; ?>" style="padding-bottom: 5px;">
    <?php
    echo CHtml::activeHiddenField($model_specimen,
            "[$model_form_id]id_specimen");
    echo CHtml::activeHiddenField($model_specimen,
            "[$model_form_id]delete");
    echo CHtml::activeTextField($model_specimen,
            "[$model_form_id]herbar_number");
